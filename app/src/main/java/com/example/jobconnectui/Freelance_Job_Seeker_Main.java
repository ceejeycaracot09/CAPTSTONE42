...
import com.example.jobconnectui.Freelance.Saved_and_JobProgress_Freelance_Jobseeker;
        ...
        jobRequestLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedTab != 4) {
                    ...
                    getSupportFragmentManager().beginTransaction()
                            .setReorderingAllowed(true)
                            .replace(R.id.fragmentContainer, Saved_and_JobProgress_Freelance_Jobseeker.class, null)
                            .commit();
